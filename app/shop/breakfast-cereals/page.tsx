...
import { ShoppingCart, Heart, Star, Coffee, Sunrise, Wheat } from "lucide-react"
...
export default function BreakfastCerealsPage() {
  const [hoveredProduct, setHoveredProduct] = useState<number | null>(null)
  const { addItem } = useCart()
  const products = getProductsByCategory("breakfast-cereals")

  const features = [
    {
      icon: <Sunrise className="w-6 h-6 text-orange-600" />,
      title: "Morning Energy",
      description: "Sustained energy to power your entire morning",
    },
    {
      icon: <Wheat className="w-6 h-6 text-amber-600" />,
      title: "Whole Grains",
      description: "Nutrient-dense whole grains and seeds for optimal nutrition",
    },
    {
      icon: <Coffee className="w-6 h-6 text-brown-600" />,
      title: "Perfect Pairing",
      description: "Delicious with milk, yoghurt, or your favorite morning beverage",
    },
  ]
    ...
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-amber-50">
      ...
      <div className="pt-20 pb-12">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-serif text-amber-900 mb-6">Breakfast & Cereals</h1>
            <p className="text-xl text-amber-800 max-w-3xl mx-auto mb-8">
              Start your day right with our wholesome breakfast cereals and granolas. Packed with nutrients, fiber, and
              natural goodness to fuel your morning adventures.
            </p>
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              <Badge className="bg-orange-100 text-orange-800 px-4 py-2">High Fiber</Badge>
              <Badge className="bg-green-100 text-green-800 px-4 py-2">Gluten-Free Options</Badge>
              <Badge className="bg-purple-100 text-purple-800 px-4 py-2">No Refined Sugar</Badge>
              <Badge className="bg-blue-100 text-blue-800 px-4 py-2">Sustained Energy</Badge>
            </div>
          </motion.div>
          ...
          >
            <h2 className="text-3xl font-serif text-amber-900 mb-4">Start Every Day Right</h2>
            <p className="text-amber-700 mb-6 max-w-2xl mx-auto">
              Transform your mornings with our nutritious breakfast options. From crunchy granolas to wholesome cereals,
              we have everything you need for a healthy start to your day.
            </p>
            <Link href="/shop">
