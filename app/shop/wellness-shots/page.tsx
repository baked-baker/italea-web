...
import { ShoppingCart, Heart, Star, Zap, Droplets, Leaf } from "lucide-react"
...
export default function WellnessShotsPage() {
  ...
  const products = getProductsByCategory("wellness-shots")

  const features = [
    {
      icon: <Zap className="w-6 h-6 text-yellow-600" />,
      title: "Concentrated Power",
      description: "Maximum nutrition in every 60ml shot for instant wellness boost",
    },
    {
      icon: <Droplets className="w-6 h-6 text-blue-600" />,
      title: "Daily Vitality",
      description: "Perfect morning ritual to energize your body and mind",
    },
    {
      icon: <Leaf className="w-6 h-6 text-green-600" />,
      title: "Pure Ingredients",
      description: "Organic, raw, and natural ingredients with no artificial additives",
    },
  ]
    ...
    <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-green-50">
      ...
      <div className="pt-20 pb-12">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-serif text-amber-900 mb-6">Wellness Shots</h1>
            <p className="text-xl text-amber-800 max-w-3xl mx-auto mb-8">
              Concentrated nutrition in every 60ml shot. From anti-inflammatory turmeric to energizing moringa, each
              shot is crafted to deliver maximum wellness benefits in a convenient, daily ritual.
            </p>
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              <Badge className="bg-yellow-100 text-yellow-800 px-4 py-2">60ml Concentrated</Badge>
              <Badge className="bg-green-100 text-green-800 px-4 py-2">Organic Ingredients</Badge>
              <Badge className="bg-blue-100 text-blue-800 px-4 py-2">Daily Wellness</Badge>
              <Badge className="bg-purple-100 text-purple-800 px-4 py-2">No Artificial Additives</Badge>
            </div>
            ...
            >
              <Image
                ...
                alt="Italea Wellness Shots Collection"
                width={600}
                height={400}
          ...
          >
            <h2 className="text-3xl font-serif text-amber-900 mb-4">Start Your Wellness Journey</h2>
            <p className="text-amber-700 mb-6 max-w-2xl mx-auto">
              Transform your daily routine with our concentrated wellness shots. Each 60ml bottle delivers powerful
              nutrition to support your health goals, from immunity to energy and everything in between.
            </p>
